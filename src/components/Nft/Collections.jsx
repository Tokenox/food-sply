...
const Collections = () => {
  return (
    <div className="lg:p-[100px] lg:pb-[156px] bg-[#FEF9F3]">
      <h1 className="text-green text-3xl xl:text-5xl font-bold mb-3 gl:mb-5">Explore Collection</h1>
      ...
      <div className="flex overflow-x-auto justify-start md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 min-[1400px]:grid-cols-4  gap-5 mt-12">
